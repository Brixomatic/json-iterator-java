...
public class TestString extends TestCase {
	...
	public void test_encoding() throws NoSuchFieldException, IllegalAccessException {
		// TODO: can't set default charset from UTF-8 to US_ASCII, as reflective access to Charset.defailtCharset is prohibited by the Java module system.
		// FIXME: crashes for UTF-16		
		...
		Any output2 = JsonIterator.deserialize("{\"name\":\"Thomas Mueller\"}", StandardCharsets.US_ASCII);
		assertEquals("{\"name\":\"Thomas Mueller\"}", JsonStream.serialize(output2, StandardCharsets.US_ASCII));
	}
	...
	public void test_invalid_string() throws IOException {
		for (String str : new String[] { "\"\\x0008\"", "\"\\u000Z\"", "\"\\u000\"", "\"\\u00\"", "\"\\u0\"", "\"\\\"", "\"\\udd1e\"", "\"\\ud834\"",
				"\"\\ud834\\x\"", "\"\\ud834\\ud834\"", }) {
			try {
				JsonIterator.deserialize(str, String.class);
			} catch (JsonException e) {} catch (IndexOutOfBoundsException e) {}
		}
	}
	...
	public void test_long_string_in_streaming() throws IOException {
		JsonIterator iter = JsonIterator.parse(new ByteArrayInputStream(
				"\"[\\\"LL\\\",\\\"MM\\\\\\/LW\\\",\\\"JY\\\",\\\"S\\\",\\\"C\\\",\\\"IN\\\",\\\"ME \\\\\\/ LE\\\"]\"".getBytes()), 2);
		assertEquals("[\"LL\",\"MM\\/LW\",\"JY\",\"S\",\"C\",\"IN\",\"ME \\/ LE\"]", iter.readString());
	}
}
